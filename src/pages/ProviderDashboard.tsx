      ...
      <main className="flex-1 md:ml-64 p-6 pt-32 md:pt-32 md:p-8 min-h-screen relative z-10">
        ...
        <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="flex gap-4">
             <div className="bg-white px-5 py-3 rounded-xl border border-primary/10 shadow-sm flex items-center gap-4">
                ...
                <div>
                   <p className="text-[9px] font-extrabold text-primary-dark/20 uppercase tracking-widest leading-none">Reputation</p>
                   <p className="text-sm font-extrabold text-primary-dark tracking-tight">4.9/5 verified</p>
                </div>
             </div>
             <button 
        ...
        {serviceLoading ? (
          <div className="py-20 text-center animate-pulse">
             ...
             <p className="text-primary/10 font-extrabold italic tracking-widest uppercase text-[10px]">Syncing Command Logs</p>
          </div>
        ) : !service ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            {/* LIVE ANALYTICS */}
            <section className="lg:col-span-12 grid grid-cols-1 md:grid-cols-4 gap-6 mb-4">
               <div className="bg-primary-dark p-6 md:p-8 rounded-[2rem] text-white shadow-2xl relative overflow-hidden flex flex-col justify-between group">
               ...
               <div className="bg-white p-6 md:p-7 rounded-[2rem] border border-primary/5 shadow-sm flex flex-col justify-between transition-all hover:shadow-xl group">
                  ...
                  <div className="space-y-6">
                    {appsLoading ? (
                      <div className="animate-pulse space-y-6">
                        {[...Array(3)].map((_, i) => <div key={i} className="h-40 bg-white rounded-[2rem]" />)}
                      </div>
                      ...
                      <AnimatePresence mode="popLayout">
                        {applications.map((app) => (
                          <motion.div 
                            ...
                            className="bg-white p-6 md:p-8 rounded-[2rem] border border-primary/5 shadow-sm hover:shadow-xl transition-all group"
                          >
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                               <div className="flex gap-6 items-center">
                                  <div className="w-16 h-16 rounded-2xl overflow-hidden border-2 border-surface-bright bg-gray-50 flex-shrink-0">
                                     {app.student?.avatar_url ? (
                                       <img src={app.student.avatar_url} alt="" className="w-full h-full object-cover" />
                                     ) : (
                                       <div className="w-full h-full flex items-center justify-center text-primary-dark/20"><Users size={24} /></div>
                                     )}
                                  </div>
                                  <div>
                                     ...
                                     <div className="flex flex-wrap gap-4">
                                        <div className="flex items-center gap-2 px-3 py-1 bg-primary/5 rounded-full">
                                           ...
                                           <span className="text-[10px] font-extrabold uppercase tracking-widest text-primary-dark/60">Institutional ID Verified</span>
                                        </div>
                                        <div className="flex items-center gap-2 px-3 py-1 bg-surface-bright border border-primary/5 rounded-full">
                                           <Star size={9} className="text-accent-gold fill-accent-gold" />
                                           <span className="text-[10px] font-extrabold uppercase tracking-widest text-primary-dark/40">Frequent Traveler</span>
                                        </div>
                                     </div>
                                  </div>
                               </div>
                                  ...
                                  {app.status === 'pending' ? (
                                    <>
                                       <button 
                                          ...
                                          className="p-4 bg-white border border-primary/10 text-primary-dark/20 hover:text-red-500 hover:border-red-100 rounded-xl transition-all"
                                       >
                                          <X size={18} />
                                       </button>
                                       <button 
                                    ...
                                    <div className="flex items-center gap-4">
                                       <div className="text-right hidden md:block">
                                          <p className="text-[10px] font-extrabold text-primary uppercase tracking-[0.2em] leading-none mb-1">Active Passenger</p>
                                          <p className="text-[11px] font-medium text-primary-dark/30">Auto-billing enabled</p>
                                       </div>
                                       <a href={`tel:${app.student?.email || ''}`} className="p-4 bg-primary/5 text-primary rounded-xl hover:bg-primary/10 transition-all">
                                          <MessageSquare size={18} />
                                       </a>
                                    </div>
                                  ) : (
                                    <span className="text-[10px] font-extrabold text-primary-dark/20 uppercase tracking-[0.2em]">{app.status}</span>
                                  )}
                               </div>
                            </div>
                      ...
                      <div className="py-20 text-center border-4 border-dashed border-primary/5 rounded-[2.5rem]">
                         <Users className="mx-auto text-primary-dark/5 mb-6" size={48} />
                         <p className="text-primary-dark/20 font-extrabold italic text-lg uppercase tracking-[0.4em]">No Active Requests</p>
                      </div>
                    )}
                  </div>
               </section>
               ...
               <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-primary/5 shadow-sm space-y-8">
                  ...
                  <div className="space-y-6">
                     <div className="flex justify-between items-center text-sm">
                        <span className="text-primary-dark/40 font-extrabold uppercase tracking-widest text-[10px]">Cycle Ends</span>
                        <span className="text-primary-dark font-extrabold font-mono">22 APR '26</span>
                     </div>
                     <div className="flex justify-between items-center text-sm">
                        <span className="text-primary-dark/40 font-extrabold uppercase tracking-widest text-[10px]">Institutional Fee</span>
                        <span className="text-primary-dark font-extrabold font-mono">-$24.00</span>
                     </div>
                     ...
                     {[
                       ...
                       <div key={idx} className="flex gap-6 items-center">
                          ...
                          <div className="space-y-1">
                             <p className="text-[10px] font-extrabold text-white/30 uppercase tracking-[0.2em]">{item.step}</p>
                             <p className="text-xs font-extrabold uppercase tracking-widest text-white">{item.label}</p>
                          </div>
                       </div>
                     ))}
                  </div>
          ...
          >
            ...
            >
              <header className="p-6 border-b border-primary/5 flex justify-between items-center bg-white">
                ...
                <button onClick={() => setShowSetup(false)} className="w-10 h-10 rounded-xl bg-primary/5 text-primary flex items-center justify-center hover:scale-105 transition-all">
                  <X size={20} />
                </button>
              </header>
              ...
              <form onSubmit={handleSetupService} className="flex-1 overflow-y-auto p-6 md:p-8 space-y-10">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {SERVICE_CATEGORIES.map(cat => (
                      ...
                      >
                        ...
                        <label 
                          htmlFor={`cat-${cat}`}
                          className="flex flex-col items-center gap-3 p-4 rounded-xl border-2 border-primary/5 bg-white text-primary-dark/40 peer-checked:border-primary peer-checked:bg-primary/5 peer-checked:text-primary transition-all cursor-pointer hover:border-primary/20"
                        >
                ...
                {/* Image Upload */}
                <div className="space-y-6">
                  <h4 className="text-[10px] font-extrabold text-primary uppercase tracking-[0.6em] border-l-2 border-primary pl-4">Service Imagery</h4>
                  <div className="flex items-center gap-8 p-6 rounded-[1.5rem] bg-surface-bright border border-primary/5 group hover:border-primary/20 transition-all">
                    <div className="w-20 h-20 rounded-2xl bg-white border-2 border-dashed border-primary/10 flex items-center justify-center text-primary/20 relative overflow-hidden group-hover:border-primary/30 transition-all">
                      {selectedFile ? (
                    ...
                    <div>
                      <p className="text-sm font-extrabold text-primary-dark tracking-tight">Upload Branding</p>
                      ...
                      <button 
                        ...
                        className="mt-4 text-[10px] font-extrabold uppercase tracking-widest text-primary hover:text-primary-dark transition-colors"
                      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                  <div className="space-y-4">
                    <label className="text-[10px] font-extrabold text-primary-dark/30 uppercase tracking-widest ml-4">Service Name</label>
                    <input 
                      name="name" 
                      required 
                  ...
                  <div className="space-y-4">
                    <label className="text-[10px] font-extrabold text-primary-dark/30 uppercase tracking-widest ml-4">Monthly Rate ($)</label>
                    <input 
                      name="price" 
                      type="number" 
                      required 
                  ...
                  <div className="md:col-span-2 space-y-4">
                    ...
                    <textarea 
                      ...
                      className="w-full p-6 rounded-2xl bg-surface-bright border border-primary/5 font-bold outline-none focus:bg-white focus:border-primary/20 transition-all resize-none" 
                    />
                  </div>
                </div>
              ...
              <footer className="p-6 md:p-8 border-t border-primary/5 bg-white flex justify-end gap-4 sticky bottom-0 z-10">
                <button 
                  type="button" 
                  onClick={() => setShowSetup(false)} 
                  className="px-8 py-4 rounded-xl text-[10px] font-extrabold uppercase tracking-widest text-primary-dark/40 hover:bg-primary/5 transition-all"
                >
                  Cancel
                </button>
                <button 
