...
import { Wifi, Zap, ArrowRight, Search, Filter, Star, MapPin, X, Home, Users, Building2, Heart } from 'lucide-react'
...
export const Explorer = () => {
  ...
  const filtered = properties.filter(p => {
    ...
    const matchesGender = selectedGender === 'All' || p.gender_requirement === selectedGender || p.gender_requirement === 'any'
    const matchesPrice = p.price <= priceRange
    const matchesType = selectedType === 'All' || p.type.toLowerCase() === selectedType.toLowerCase()
    return matchesSearch && matchesGender && matchesPrice && matchesType
  })
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <section className="lg:col-span-8 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              {loading ? (
                [1, 2, 3, 4].map((i) => (
                  <div key={i} className="aspect-[4/5] bg-white border border-primary/5 animate-pulse rounded-[3rem]" />
                ))
              ) : error ? (
                ...
                <div className="col-span-full py-32 text-center space-y-4">
                    <div className="w-20 h-20 bg-white rounded-[2.5rem] flex items-center justify-center mx-auto text-primary/10 shadow-sm border border-primary/5">
                      <Search size={40} />
                    </div>
                    ...
                    <button onClick={() => {setSearch(''); setSelectedGender('All'); setSelectedType('All'); setPriceRange(1000);}} className="text-primary font-black uppercase tracking-widest text-[10px] mt-4 hover:underline">Clear all filters</button>
                </div>
              ) : (
                <AnimatePresence mode="popLayout">
                  {filtered.map((prop, idx) => (
                    <motion.div
                      ...
                      className="group bg-white rounded-[3rem] overflow-hidden border border-primary/5 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 text-left"
                    >
                        ...
                        <div className="relative h-64 overflow-hidden">
                          ...
                          <div className="absolute top-6 left-6">
                            <div className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-2xl flex items-center gap-2 shadow-xl border border-white/20">
                              ...
                              <span className="text-[11px] font-black text-primary-dark">{prop.rating || '4.5'}</span>
                            </div>
                          </div>
                          <div className="absolute bottom-6 left-6 flex gap-2">
                            ...
                            <span className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-xl text-[9px] font-black text-primary-dark uppercase tracking-[0.1em] shadow-sm">
                              Verified
                            </span>
                          </div>
                        </div>
                        <div className="p-8">
                          <div className="flex justify-between items-start mb-4 gap-4">
                            ...
                            <div className="text-right shrink-0">
                              ...
                              <p className="text-[9px] text-primary-dark/30 font-bold uppercase tracking-[0.2em] mt-1">/mo</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center justify-between pt-6 border-t border-primary/5">
                            <div className="flex gap-4">
                              <div className="flex items-center gap-2 text-primary-dark/30">
                                <Wifi size={14} />
                                <span className="text-[9px] font-black uppercase tracking-widest">Fiber</span>
                              </div>
                              <div className="flex items-center gap-2 text-primary-dark/30">
                                <Zap size={14} />
          ...
          <aside className="lg:col-span-4 space-y-8">
            <div className="bg-white rounded-[3rem] p-10 space-y-12 border border-primary/5 shadow-sm sticky top-32">
              <div className="space-y-6">
                <h3 className="text-primary-dark font-manrope font-black text-[10px] uppercase tracking-[0.3em]">Search Mutare</h3>
                <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="Neighborhood or hostel..."
                      className="w-full pl-16 pr-6 py-5 bg-[#F8F9F8] rounded-[1.5rem] border border-primary/5 outline-none text-sm font-dm-sans focus:border-primary/20 transition-all font-bold"
                    />
                    {search && (
              ...
              <div className="space-y-8">
                <h3 className="text-primary-dark font-manrope font-black text-[10px] uppercase tracking-[0.3em]">Gender Housing</h3>
              ...
              <div className="space-y-8">
                 <div className="flex justify-between items-end">
                  <h3 className="text-primary-dark font-manrope font-black text-[10px] uppercase tracking-[0.3em]">Price Cap</h3>
                ...
                <input 
                  ...
                  className="w-full h-2 bg-[#F8F9F8] rounded-lg appearance-none cursor-pointer accent-primary" 
                />
              ...
              <div className="pt-8 border-t border-primary/5">
                <div className="bg-primary/5 p-6 rounded-[2rem] border border-primary/10 border-dashed text-center">
                  <p className="text-[10px] text-primary/60 font-black uppercase tracking-widest mb-2">Notice</p>
