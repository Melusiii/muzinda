        ...
        >
          ...
          <div className="flex-1 bg-surface-bright relative group">
            ...
            <div className="absolute top-1/4 left-1/3">
              <div className="relative group/pin">
                ...
                <div className="absolute top-10 left-1/2 -translate-x-1/2 bg-white px-3 py-1.5 rounded-lg shadow-xl border border-primary/5 whitespace-nowrap opacity-0 group-hover/pin:opacity-100 transition-opacity">
                  <p className="text-[10px] font-bold text-primary-dark font-geist">Main Administration</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-1/3 right-1/4">
               <div className="relative group/pin">
                ...
                <div className="absolute top-10 left-1/2 -translate-x-1/2 bg-white px-3 py-1.5 rounded-lg shadow-xl border border-primary/5 whitespace-nowrap opacity-0 group-hover/pin:opacity-100 transition-opacity">
                  <p className="text-[10px] font-bold text-primary-dark font-geist">Dining Hall & Hub</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute top-1/2 left-2/3">
               <div className="relative group/pin">
                ...
                <div className="absolute top-10 left-1/2 -translate-x-1/2 bg-white px-3 py-1.5 rounded-lg shadow-xl border border-primary/5 whitespace-nowrap opacity-0 group-hover/pin:opacity-100 transition-opacity">
                  <p className="text-[10px] font-bold text-primary-dark font-geist">Student Library</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-12 left-12 flex flex-col gap-2">
               <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-primary/5 flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold text-primary-dark font-geist">Muzinda Campus</p>
          ...
          <div className="w-full md:w-80 bg-white border-l border-primary/5 p-8 flex flex-col">
            <div className="flex justify-between items-start mb-8">
               <div>
                  <h2 className="text-2xl font-geist font-extrabold text-primary-dark leading-tight">Campus Navigator</h2>
                  <p className="text-xs text-primary-dark/40 font-geist mt-1 italic">V1.0 Independent Hub</p>
               </div>
            ...
            <div className="space-y-6 flex-1">
               ...
               <div className="p-6 rounded-2xl bg-primary/5 border border-primary/10 space-y-3">
                  <div className="flex items-center gap-2 text-primary">
                    <Info size={16} />
                    <span className="text-xs font-bold font-geist">Live Tracking</span>
                  </div>
                  <p className="text-[11px] text-primary-dark/60 leading-relaxed font-geist">
                    Enable GPS to see shuttle positions in real-time. Contact security for emergency escort services.
                  </p>
               </div>
            </div>

            <button className="w-full mt-6 bg-primary text-white py-4 rounded-xl font-bold font-geist shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all">
              Launch Detailed Map
            </button>
          </div>
        </motion.div>
